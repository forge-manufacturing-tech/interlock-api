...
export default function AddChildModal({
    ...
    const updateInputsMutation = useMutation({
        mutationFn: async (_newPartInput: { resource_id: string; quantity: number; unit: string }) => {
            void _newPartInput;
            // Input updating logic is moved to full tree patch later.
                                    ...
                                    <div className="divide-y divide-border">
                                        {filteredParts.map((part) => (
                                            <button
                                                ...
                                                className={`flex w-full items-center justify-between px-4 py-2 text-left transition-colors hover:bg-surface-hover ${selectedPartId === part.id ? "bg-primary/10" : ""
                                                    }`}
                                            >
                                                <div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-2 rounded-lg border p-4 transition-all ${newPartType === "purchase"
                                ...
                                <button
                                    ...
                                    className={`flex flex-col items-center gap-2 rounded-lg border p-4 transition-all ${newPartType === "assemble"
                                        ? "border-primary bg-primary/10 text-primary"
                                        : "border-border bg-surface-light text-text-muted hover:border-text-secondary"
                                        }`}
                                >
